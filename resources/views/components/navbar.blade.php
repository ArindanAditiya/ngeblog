        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <x-nav-link href="/posts" :current="request()->is('posts') || request()->is('post/*')">Posts</x-nav-link>
    ...
    <el-disclosure id="mobile-menu" hidden class="block md:hidden">
      ...
      <div class="border-t border-white/10 pt-4 pb-3"> 
        <div class="flex items-center px-5">
          ...
          <div class="ml-3">
            <div class="text-base/5 font-medium text-white">Arindan Aditiya</div>
            <div class="text-sm font-medium text-gray-400">indangaming003@gmail.com</div>
          </div>
        </div>
        <div class="mt-3 space-y-1 px-2">
          ...
          <a href="#" class="block rounded-md px-3 Ppy-2 text-base font-medium text-gray-400 hover:bg-white/5 hover:text-white">Settings</a>
